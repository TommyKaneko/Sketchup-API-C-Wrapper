...
typedef enum {
  ...
  LODimensionRotationAlignment_Perpendicular,  ///< Align the text perpendicular to the dimension line.
...
@brief Adds a style to apply to an entity's sub-entity. This would be used to
       set the arrow head type the extension lines of a dimension, for example.
