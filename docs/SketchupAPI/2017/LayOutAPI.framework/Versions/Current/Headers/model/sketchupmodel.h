...
@brief Defines the standard views available for a SketchUp model.
*/
typedef enum {
  LOSketchUpModelStandardView_Top = 0,        ///< Top
  LOSketchUpModelStandardView_RelativeTop,    ///< Top (Relative)
  LOSketchUpModelStandardView_Bottom,         ///< Bottom
  LOSketchUpModelStandardView_RelativeBottom, ///< Bottom (Relative)
  LOSketchUpModelStandardView_Front,          ///< Front
  LOSketchUpModelStandardView_Back,           ///< Back
  LOSketchUpModelStandardView_Left,           ///< Left
  LOSketchUpModelStandardView_Right,          ///< Right
  LOSketchUpModelStandardView_Iso,            ///< Iso
...
- \ref SU_ERROR_SERIALIZATION if the SketchUp file could not be loaded
*/
