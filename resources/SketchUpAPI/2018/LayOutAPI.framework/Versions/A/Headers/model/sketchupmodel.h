...
typedef enum {
  ...
  LOSketchUpModelStandardView_RelativeTop,    ///< Top (Relative). This top view is oriented relative to the previous camera position.
  LOSketchUpModelStandardView_Bottom,         ///< Bottom. This view is aligned with the X and Y axes.
  LOSketchUpModelStandardView_RelativeBottom, ///< Bottom (Relative). This bottom view is oriented relative to the previous camera position.
  ...
  LOSketchUpModelStandardView_Iso,            ///< Iso. This is aligned with the nearest isometric axes to the current view.
