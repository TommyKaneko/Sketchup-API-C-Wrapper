...
*/
LO_RESULT LOPathCreateArc(LOPathRef* path, const LOPoint2D* center_point,
...
*/
LO_RESULT LOPathGetCircle(LOPathRef path, bool* is_circle, LOPoint2D* center,
    double* radius);
...
*/
LO_RESULT LOPathGetArc(LOPathRef path, bool* is_arc, LOPoint2D* center,
    double* radius, double* start_angle, double* end_angle);
