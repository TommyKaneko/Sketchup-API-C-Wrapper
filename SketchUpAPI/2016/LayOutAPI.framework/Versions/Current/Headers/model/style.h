...
@brief Defines the different units formats that are available for dimensions.
*/
typedef enum {
...
typedef enum {
  ...
  LOSubEntityType_DimensionStartExtensionLine, ///< A linear dimension's start extension line object.
  LOSubEntityType_DimensionEndExtensionLine,   ///< A linear dimension's end extension line object.
  LOSubEntityType_DimensionDimensionLine,      ///< A linear dimension's dimension line object.
  LOSubEntityType_DimensionLeaderLine,         ///< A linear dimension's leader line object.
  LOSubEntityType_DimensionText,               ///< A linear dimension's text object.
  LONumSubEntityTypes
} LOSubEntityType;
...
@param[in]  style        The style object.
@param[out] stroke_color Whether there is a stroke or not.
@return
- \ref SU_ERROR_NONE on success
- \ref SU_ERROR_INVALID_INPUT if style does not refer to a valid object
...
@param[in] style        The style object.
@param[in] stroke_color The stroke width.
@return
- \ref SU_ERROR_NONE on success
- \ref SU_ERROR_INVALID_INPUT if style does not refer to a valid object
*/
...
- \ref SU_ERROR_NONE on success
- \ref SU_ERROR_INVALID_INPUT if style does not refer to a valid object
- \ref SU_ERROR_OUT_OF_RANGE if pattern_scale is less than 0.1 or greater than
  9999.0
*/
...
- \ref SU_ERROR_INVALID_INPUT if style does not refer to a valid object
  attribute
- \ref SU_ERROR_OUT_OF_RANGE if scale is less than 0.1 or greater than
  9999.0
*/
...
@brief Adds a style to apply to an entity's sub-entity. This would be used to
       set the arrow head type the extension lines of a linear dimension, for
       example.
...
@brief Gets the style settings for a sub entity from a style. This would be used
       to get the current style of a linear dimension's text, for example.
