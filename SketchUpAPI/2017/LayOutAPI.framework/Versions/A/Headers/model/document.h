...
typedef enum {
  ...
  LODocumentVersion_Current = LODocumentVersion_2017, ///< The most current version supported.
...
/**
@brief Releases a document object. *document will be set to invalid by this
       function. Note: it is important to call LODocumentRelease before calling
       \ref LOTerminate, otherwise LODocumentRelease may fail unpredictably.
...
/**
@brief Gets the size of list of auto text definitions.
@since LayOut 2017, API 2.0
@param[in]  document The document object.
...
- \ref SU_ERROR_UNSUPPORTED if autotext is a mandatory type
*/
